...
export default class Message extends Model {
    ...
    getViewElement(me = true){
                    ...
                    <div class="_3_7SH kNKwo tail">
                        ...
                        <div class="_1YNgi copyable-text">
                            <div class="_3DZ69" role="button">
                                ...
                                <div class="_1lC8v">
                                    <div dir="ltr" class="_3gkvk selectable-text invisible-space copyable-text">Nome do
                                        Contato Anexado</div>
                                </div>
                                <div class="_3a5-b">
        ...
        if (me) {
            ...
            div.querySelector('.message-time').parentElement.appendChild(this.getStatusViewElememnt())
        }
