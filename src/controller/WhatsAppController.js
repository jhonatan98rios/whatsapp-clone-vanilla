...
export default class WhatsAppController {
    ...
    setActiveChat(contact) {
        ...
        //this.el.activeStatus.innerHTML = contact.status //Bugfix
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs => {
            ...
            docs.forEach(doc => {
                ...
                if (!this.el.panelMessagesContainer.querySelector('#_' + data.id)) {
                    ...
                    // This is like a innerHTML, but dont remove de the events of child elements
            ...
            /* This is a temporaly solution for a Bug */

            let messagesNodeList = this.el.panelMessagesContainer.querySelectorAll('.message')
            let messagesArray = [...messagesNodeList]
            let latestMessage = messagesArray[messagesArray.length - 1]

            let ltsText = latestMessage.querySelector('.message-text').innerHTML // Get latest message
            let latestTime = latestMessage.querySelector('.message-time').innerHTML // Get latest time

            console.log(latestTime)

            let contactNodeList = this.el.contactsMessagesList.querySelectorAll('.contact-item')
            let contactArray = [...contactNodeList]
            
            let contactLtsMessage = contactArray[0].querySelector('.last-message')
            let contactLtsTime = contactArray[0].querySelector('._3Bxar')

            contactLtsMessage.innerHTML = ltsText //Set on interface, latest message
            contactLtsTime.innerHTML = latestTime //Set on interface, latest time
